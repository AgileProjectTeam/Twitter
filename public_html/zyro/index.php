...
error_reporting(E_ALL); @ini_set('display_errors', true);
	$pages = array(
		'0'	=> array('id' => '1', 'alias' => 'İndex', 'file' => '1.php'),
		'1'	=> array('id' => '3', 'alias' => 'Log-in', 'file' => '3.php'),
		'2'	=> array('id' => '2', 'alias' => 'Following-x', 'file' => '2.php'),
		'3'	=> array('id' => '6', 'alias' => 'Following-y', 'file' => '6.php'),
		'4'	=> array('id' => '8', 'alias' => 'My-Page', 'file' => '8.php')
	);
	$forms = array(
	...
	$base_url = '/';
	$user_domain = 'agile123.000webhostapp.com';
	$show_comments = false;
	include dirname(__FILE__).'/functions.inc.php';
	$home_page = '1';
	list($page_id, $lang, $urlArgs, $route) = parse_uri();
	$user_key = "jyqCSFBhTtTr3SQfFN0tNH+dxa/H3iw/hpM=";
	$user_hash = "e08b010066933010";
