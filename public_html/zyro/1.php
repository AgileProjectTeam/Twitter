...
<head>
	...
	<link href="css/1.css?ts=1491683596" rel="stylesheet" type="text/css" />
...
<div id="wb_element_instance0" class="wb_element"><ul class="hmenu"><li class="active"><a href="%C4%B0ndex/" target="_self" title="İndex">İndex</a></li><li><a href="Log-in/" target="_self" title="Log in">Log in</a></li><li><a href="Following-x/" target="_self" title="Following (x)">Following (x)</a></li><li><a href="Following-y/" target="_self" title="Following (y)">Following (y)</a></li><li><a href="My-Page/" target="_self" title="My Page">My Page</a></li></ul><div class="clearfix"></div></div></div>
<div class="vbox wb_container" id="wb_main">
	
<div id="wb_element_instance1" class="wb_element wb-elm-orient-horizontal"><div class="wb-elm-line"></div></div><div id="wb_element_instance2" class="wb_element" style=" line-height: normal;"><h1 class="wb-stl-heading1" style="text-align: center;">Our new web site is coming very soon</h1></div><div id="wb_element_instance3" class="wb_element wb-elm-orient-horizontal"><div class="wb-elm-line"></div></div><div id="wb_element_instance4" class="wb_element" style=" line-height: normal;"><p style="text-align: center;">Bazı hakları saklıdır.</p>
